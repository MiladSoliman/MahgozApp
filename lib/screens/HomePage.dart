...
import 'package:minamakram/viewmodel/home_viewmodel.dart';
...
class _homeWidgetState extends State<homeWidget> {
  ...
  void didChangeDependencies() {
     ...
     homeController.getBuildings(context);
  ...
  Widget _buildingsList() {
        ...
        Consumer <BuildingsProvider>(
         builder:(BuildContext context,buildings,Widget?child) {
           ...
           return CarouselSlider(
               ...
               items: homeController.buildings
    ...
    Row(
          ...
          children:  homeController.buildings.asMap().entries.map((entry) {
  ...
  Widget _shimmerBuildings(){
     return CarouselSlider(
       ...
       items: List.generate(3, (index) => _shimmerBuildingItem(), // 3 placeholders
     ));
  }

  Widget _shimmerBuildingItem() {
    return Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    color: (Theme.of(context).brightness == Brightness.dark
                            ? Colors.white
                            : Colors.black)
                        .withOpacity(_aboTlatIndex == entry.key ? 0.9 : 0.4)),
              ),
            );
          }).toList(),
        ),

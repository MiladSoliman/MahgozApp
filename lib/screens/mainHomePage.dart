...
class _mainHomePageState extends State<mainHomePage> {
  ...
  //TODO: temporarily
  bool isAdmin = SPUtils().getIsAdminUser();
      ...
      receiver.messages.listen((event) {
        switch (event.name) {
          case "Third page":
            setState(() {
              Order order = Order();
              order.hallId = event.data?["hallId"];
              myOrder.hallId = event.data?["hallId"];
              ...
              startWidget = RequestingOrderHallSecondWidget(
                order: order,
              );
          ...
          case "Fourth page":
            setState(() {
              ...
              startWidget = RequestingOrderHallThirdWidget(
                order: order,
              );
          ...
          case "second time page":
            setState(() {
              ...
              startWidget = RequestingOrderTimeSecondWidget(
                order: order,
              );
              colors[4] = MyColors.secondaryColor;
              colors[5] = MyColors.secondaryColor;
          ...
          case "third time page":
            setState(() {
              ...
              startWidget = RequestingOrderTimeThirdWidget(
                order: order,
              );
              colors[6] = MyColors.secondaryColor;
            });
     ...
     /*   title: Row(
          ...
          children: [
            IconButton(
              ...
              onPressed: () async {
                bool res =
                    await Navigator.pushNamed(context, notification) as bool;
                setState(() {

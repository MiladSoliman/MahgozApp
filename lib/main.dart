...
import 'package:minamakram/state/avalible_budilings_state.dart';
...
void main() async {
  ...
  SPUtils.instance.initSharePre();
  runApp(appWidget);
}

Widget appWidget = MultiProvider(providers: [
  ChangeNotifierProvider(create: (context) => BuildingsProvider()),
  ChangeNotifierProvider(create: (context) => AvailableBuildingsProvider() ),
  ChangeNotifierProvider(create: (context) => AvailableTimesProvider()),
],
